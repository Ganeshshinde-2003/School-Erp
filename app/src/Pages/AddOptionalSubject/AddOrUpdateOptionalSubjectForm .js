...
const AddOrUpdateOptionalSubjectForm = ({
  ...
  const getSubjectData = async (subjectAutoGeneratedId) => {
    try {
      const subject = await getOptionalSubjectFromDatabase(subjectAutoGeneratedId);
  ...
  const handleUpdate = async () => {
    try {
      const response = await updateOptionalSubjectDatabase(subjectAutoGeneratedId, subjectData);
