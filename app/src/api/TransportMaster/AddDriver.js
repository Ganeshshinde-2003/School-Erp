...
export const updateDriverDataToDatabase = async (documentId, updateddriverData) => {
    ...
    try {
        ...
        const driverDataChanged = JSON.stringify(existingData) !== JSON.stringify(updateddriverData);
