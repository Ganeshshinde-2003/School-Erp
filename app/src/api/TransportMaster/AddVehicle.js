...
export const updateVehicleDataToDatabase = async (documentId, updatedvehicleData) => {
    ...
    try {
        ...
        const vehicleDataChanged = JSON.stringify(existingData) !== JSON.stringify(updatedvehicleData);
