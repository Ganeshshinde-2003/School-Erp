...
export const updateExpenseDataToDatabase = async (documentId, updatedexpenseData) => {
    ...
    try {
        ...
        const expenseDataChanged = JSON.stringify(existingData) !== JSON.stringify(updatedexpenseData);
